...
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/User_Tabelle.csv' INTO TABLE User_Tabelle FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/brands_list.csv' INTO TABLE brands_list FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/fsk_list.csv' INTO TABLE fsk_list FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/preise_list.csv' INTO TABLE preise_list FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/genre_list.csv' INTO TABLE genre_list FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/mode.csv' INTO TABLE mode_list FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/price_sort.csv' INTO TABLE price_sort FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
$sqlBefehl = "LOAD DATA INFILE '/xampp/htdocs/dhbw/ludomo/csv/platform.csv' INTO TABLE platform FIELDS TERMINATED BY ';'  LINES STARTING BY '' IGNORE 1 LINES;";
$abfrage = $verbindung->prepare($sqlBefehl);
$abfrage->execute();
}
$verbindung=null;
